...
export class BlogService {
    ...
    addingBlog(detail): Observable<any> {
        ...
        return this.http.post('http://54.158.231.106:8080/api/blog', details, httpOptions);
    }
    ...
    deleteRatedBlog(id): Observable<any> {
        return this.http.delete('http://54.158.231.106:8080/api/blog/' + id);
    }
    ...
    // deleteRatedBlog(id): Observable<any> {
    //     return this.http.delete('/server/api/blog/' + id);
    // }
